...
// ----------------------------------------------------------------------
async function addNewSupplier(first_name, last_name, email, contact, city, province, company, website, address, token) {
  ...
  try {
      const response = await axios({
          ...
          data: {
            query: `
              mutation AddSupplier ($Company: String, $firstName: String!, $lastName: String!, $Contact: String, $Email: EmailAddress, $Website: String, $Address: String, $City: String!, $Province: String!) {
                creteSupplier (company_name: $Company, first_name: $firstName, last_name: $lastName, contact_number: $Contact, email: $Email, website: $Website, address: $Address, city: $City, province: $Province) {
                      id
                      first_name
                      last_name
                  }
...
export default function RegisterSupplier() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const newSupplier = await addNewSupplier(values.firstName, values.lastName, values.email, values.contactNumber, resultCity.city, resultProvince, values.companyName, values.website, values.address, session.access_token);
