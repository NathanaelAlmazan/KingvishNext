  ...
  if (onHead) {
    return (
        <>
          ...
          >
            <MenuItem onClick={event => handleFilterMenuChange("desc", "total_bought")} sx={{ color: 'text.secondary' }}>
              <ListItemText primary="Total Orders: High-Low" primaryTypographyProps={{ variant: 'body2' }} />
            </MenuItem>

            <MenuItem onClick={event => handleFilterMenuChange("asc", "total_bought")} sx={{ color: 'text.secondary' }}>
              <ListItemText primary="Total Orders: Low-High" primaryTypographyProps={{ variant: 'body2' }} />
            </MenuItem>
          </Menu>
        </>
    );
  ...
  return (
    <>
      ...
      <Menu
        ...
        transformOrigin={{ vertical: 'top', horizontal: 'right' }}
      >
        <MenuItem onClick={e => onRouterClick(e, '/customers/profile/' + id)} sx={{ color: 'text.secondary' }}>
          <ListItemIcon>
            <AccountBoxIcon />
          </ListItemIcon>
