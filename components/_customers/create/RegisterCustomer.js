...
// ----------------------------------------------------------------------
async function addNewCustomer(first_name, last_name, email, contact, city, province, company, website, address, token) {
  ...
  try {
      const response = await axios({
          ...
          data: {
            query: `
              mutation AddCustomer ($Company: String, $firstName: String!, $lastName: String!, $Contact: String, $Email: EmailAddress, $Website: String, $Address: String, $City: String!, $Province: String!) {
                  addCustomer (company_name: $Company, first_name: $firstName, last_name: $lastName, contact_number: $Contact, email: $Email, website: $Website, address: $Address, city: $City, province: $Province) {
                      id
                      first_name
                      last_name
                      company_name
...
export default function RegisterCustomer() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      const newCustomer = await addNewCustomer(values.firstName, values.lastName, values.email, values.contactNumber, resultCity.city, resultProvince, values.companyName, values.website, values.address, session.access_token);
